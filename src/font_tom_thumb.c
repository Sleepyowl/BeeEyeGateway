 ...
 * Size: 6 px
 * Bpp: 1
 * Opts: --bpp 1 --size 6 --no-compress --stride 1 --align 1 --font tom-thumb.ttf --range 32-127 --format lvgl -o font_tom_thumb.c
 ******************************************************************************/
...
#ifndef FONT_TOM_THUMB
#define FONT_TOM_THUMB 1
#endif
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_tom_thumb = {
#else
lv_font_t font_tom_thumb = {
#endif
